...
<table class="table">
    ...
    foreach ($response as $currentRow) {
        echo '<tr>';
        echo "<td>" . $currentRow['idJugadore'] . "</td>";
        echo "<td>" . $currentRow['nombreJugador'] . "</td>";
        echo "<td>" . $currentRow['posicion'] . "</td>";
        echo "<td>" . $form->getTeam($currentRow['idEquipo']) . "</td>";
        echo '</tr>';
    }
    ?>
    </tbody>
